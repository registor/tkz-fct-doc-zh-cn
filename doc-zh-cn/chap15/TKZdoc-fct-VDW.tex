...
\subsection{\tkzname{Van der Waals}曲线}
...
令$v$表示体积，$p$表示压力。
设$b$和$k$是两个正实数，Van~der~Waals提出了一个表示这些之间关系的函数：
\[
...
\newpage
\subsubsection{\emph{b}=32/27的第3曲线 }
